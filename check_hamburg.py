...
card = requests.get(f'{TRELLO_API_BASE}/cards/68ee3e085af6adcdf4921d76?fields=all', params=auth).json()

print('=' * 70)
print('VARO Energy Hamburg Card - Location Check')
print('=' * 70)
...
print('=' * 70)
print("\nCheck in UI: https://trello.com/c/pMWB44T3")
